...
DEFAULT_DIRECT_JOINT_CALIBRATION_FILE = ORCA_CONFIG_DIR / "direct_joint_teleop_calibration.json"
ORCA_DEPENDENCIES_DIR = ROBOT_MANIPULATION_ROOT / "orca_control" / "orca_dependencies"
DEFAULT_ORCAHAND_V1_RIGHT_CONFIG_FILE = (
    ORCA_DEPENDENCIES_DIR / "orca_core" / "models" / "v1" / "orcahand_right" / "config.yaml"
)
